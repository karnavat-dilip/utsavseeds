  ...
  const bajraProducts = [
    {
      ...
      description: [
        ...
        'Plant medium tall & 70-75 day for maturity',
    ...
    },
    {
      ...
      description: [
        ...
        'Highly tolerant to heat & logging',
        'Stay green at harvest and hence good fodder',
        'Grain colour light grey & bold',
        'More productive tillers',
        'Ear head long & compact',
        'Dual purpose hybrid.',
      ],
    },
    {
