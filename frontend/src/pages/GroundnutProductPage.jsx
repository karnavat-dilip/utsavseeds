...
const GroundnutProductPage = () => {
  ...
  return (
    <div className="page-wrapper">
      <Navbar />
      <section className="page-hero-section" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1615485925511-b4f8e951e87f?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80)' }}>
        ...
        <div className="container">
          ...
          >
            Groundnut Seeds Supplier in India
          </motion.h1>
        </div>
      </section>
          ...
          <div className="product-detail-page-content">
            <div className="product-detail-main-content">
              <motion.h2
                ...
                transition={{ duration: 0.6 }}
              >
                Leading Producer of Groundnut Seeds in India
              </motion.h2>
              ...
              >
                {groundnutProducts.map((product, index) => (
                  <motion.div
                    key={product.id}
...
export default GroundnutProductPage;
