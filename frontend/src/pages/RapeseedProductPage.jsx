...
const RapeseedProductPage = () => {
  useEffect(() => {
    AOS.init({ duration: 1000, once: true });
    window.scrollTo(0, 0);
  }, []);

  const rapeseedProducts = [
    {
      id: 1,
      name: 'UTSAV RAPESEED PREMIUM',
      image: 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
      description: [
        'High-yield rapeseed variety',
        'Excellent oil content and quality',
        'Resistant to diseases and pests',
        'Early maturing for timely harvest',
        'Suitable for various soil types and climates'
      ]
    }
  ];
    ...
    <div className="page-wrapper">
      ...
      <section className="page-hero-section" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1593113598332-cd288d649433?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80)' }}>
        ...
        <div className="container">
          ...
          >
            Rapeseed Seeds Supplier in India
          </motion.h1>
        </div>
      </section>
          ...
          <div className="product-detail-page-content">
            <div className="product-detail-main-content">
              <motion.h2
                ...
                transition={{ duration: 0.6 }}
              >
                Leading Producer of Rapeseed Seeds in India
              </motion.h2>
              ...
              >
                {rapeseedProducts.map((product, index) => (
                  <motion.div
                    key={product.id}
...
export default RapeseedProductPage;
